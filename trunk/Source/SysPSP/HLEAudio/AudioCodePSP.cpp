...
static const u32	BUFFER_SIZE = 1024 * 32;		// Usually have to provide 1024 samples at a time, so this gives us 8 batches of them
...
,	mBufferLength( 0 )
{
	...
	mAudioBufferUncached = ( (CAudioBuffer*)((int)mem | 0x40000000) );
